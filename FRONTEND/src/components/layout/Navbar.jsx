        ...
        <div className="flex items-center justify-between h-18">
          ...
          <a href="/" className="flex items-center space-x-2.5 group">
            <div className="w-9 h-9 bg-gradient-to-br from-violet-400 to-purple-500 rounded-xl flex items-center justify-center shadow-lg shadow-violet-500/20 group-hover:shadow-violet-500/40 transition-all duration-300 group-hover:scale-105">
              ...
              <span className="text-4xl font-bugate text-gray-900 tracking-tight">
               AI eBook Creator
              </span>
          </a>
          ...
          <div className="hidden lg:flex items-center space-x-3">
            {isAuthenticated ? (
              ...
              <>
                ...
                <a
                  href="/signup"
                  className="px-5 py-2 text-sm font-berny font-medium text-white bg-gradient-to-r from-violet-400 to-purple-500 rounded-lg hover:from-violet-700 hover:to-purple-700 shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 transition-all duration-200 hover:scale-105"
                >
                  Get Started
                </a>
              </>
